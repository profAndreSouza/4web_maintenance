...
export function MainChart() {
  return (
    <Card className="mx-auto max-w-lg bg-white/40">
      <p className="text-tremor-default flex items-center justify-between text-tremor-content dark:text-dark-tremor-content">
        <span>Source</span>
        <span>Views</span>
      </p>
